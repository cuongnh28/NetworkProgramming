...
public class ClientView extends javax.swing.JFrame {
    ...
    public ClientView() {
        initComponents();
        String col[] = {"ID", "Name", "Birth", "Course", "Address"};
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int row = jTable1.getSelectedRow();
        Student std = new Student(Integer.parseInt(jTable1.getValueAt(row, 0).toString()), jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), jTextField5.getText());
        ctr = new ClientControl();
        ctr.sendStudent(std);
        if(ctr.receiveUpdate())
